...
$account     = 'DomainName' # Atlassian subdomain i.e. whateverproceeds.atlassian.net
$username    = 'Username@Example.com' # username with domain something@domain.com
$token    = 'Token' # Token created from product https://confluence.atlassian.com/cloud/api-tokens-938839638.html
$destination = 'D:\Path\to\backup\destination' # Location on server where script is run to dump the backup zip file.
